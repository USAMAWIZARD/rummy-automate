...
from constants import sequence_and_rest_cards, four_cards, ranks
from check import *
    ...
    while i < (len(p_cards) - 1):
        ...
        if difference == 2:
            ...
            if joker != False:
                ...
                joker_status = True
        if difference > 2 or difference == 0 or (joker_status and difference == 2):
            slice_end = i + 1
...
def getValidCards(hand_cards, p_deck):
    global deck
    deck = p_deck
